...
impl AtmosphereModel {
    ...
    pub fn conditions_with_variation(&self, altitude: f64, variation_percent: f64) -> AtmosphericConditions {
    ...
    fn density_variation_coefficient(&self, altitude: f64, input_percent: f64) -> f64 {
        ...
        let minus_x = [21.6, 7.4, -1.3, -14.3, -15.9, -18.6, -32.1, -38.6, -50.0, -55.3, -65.0, -68.1, -76.7, -42.2];
        let minus_y = [1010.0, 4300.0, 8030.0, 10220.0, 16360.0, 20300.0, 26220.0, 29950.0, 40250.0, 50110.0, 59970.0, 70270.0, 80140.0, 90220.0];
        
        // Data from U.S. Standard Atmosphere - positive variation
        let plus_x = [-12.8, -7.9, 1.5, 5.3, 26.7, 20.2, 14.3, 18.2, 33.6, 47.4, 59.5, 72.2, 58.7, 41.4];
        let plus_y = [1230.0, 4300.0, 8030.0, 10000.0, 16360.0, 20300.0, 26220.0, 29950.0, 40250.0, 50110.0, 59970.0, 70270.0, 80360.0, 90880.0];
...
mod tests {
    ...
    fn test_density_variation() {
        ...
        assert_relative_eq!(conditions_nominal.density, conditions_standard.density, epsilon = 1e-12);
