...
def flight_simulator(json_file = "param_momo0.json",
                     change_key1 = "name",
                     change_key2 = None,
                     change_key3 = None,
                     change_value = "test"):
    ...
    impact_point_index =  outputlist.index("1st")
    impact_point_lat_index = impact_point_index + 5
    impact_point_lon_index = impact_point_index + 6
...
if __name__ == '__main__':
    ...
    for i, deg in enumerate(elevation):
        lat_a[i], lon_a[i] = flight_simulator(json_file = "temp.json",
                                    change_key1 = "1st stage",
                                    change_key2 = "attitude",
                                    change_key3 = "initial elevation[deg]",
                                    change_value = deg)
